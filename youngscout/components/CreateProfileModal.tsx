...
type NewProfileData = Omit<Player, 'id' | 'videoUrl' | 'profileImageUrl' | 'talentScore' | 'tags' | 'status'>;

interface CreateProfileModalProps {
    onClose: () => void;
    onCreatePlayer: (playerData: NewProfileData) => void;
}
...
export const CreateProfileModal: React.FC<CreateProfileModalProps> = ({ onClose, onCreatePlayer }) => {
    const [profileData, setProfileData] = useState<NewProfileData>({
        name: '',
        age: 10,
