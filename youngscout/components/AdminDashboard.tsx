...
interface AdminDashboardProps {
    players: Player[];
    onSuspendPlayer: (playerId: number) => void;
    onDeletePlayer: (playerId: number) => void;
}

const SuspendIcon: React.FC<{ className?: string }> = ({ className = "h-5 w-5" }) => (
...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({ players, onSuspendPlayer, onDeletePlayer }) => {
    return (
