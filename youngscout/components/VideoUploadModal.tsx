...
const getPresignedUrl = async (file: File, playerId: number): Promise<{ uploadUrl: string; videoUrl: string }> => {
...
const uploadFile = (url: string, file: File, onProgress: (percentage: number) => void): Promise<void> => {
...
export const VideoUploadModal: React.FC<VideoUploadModalProps> = ({ player, onClose, onUploadComplete }) => {
