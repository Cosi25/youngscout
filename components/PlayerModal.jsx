...
import { POPULAR_TAGS } from '../constants.js';
...
const ContactIcon = ({ className = "h-5 w-5 mr-2" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 20 20" fill="currentColor">
...
export const PlayerModal = ({ player, onClose, onOpenUploadModal, onUpdatePlayer, userRole, onInitiateContact, isContacted }) => {
